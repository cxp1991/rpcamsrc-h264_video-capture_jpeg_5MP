...
GType gst_rpi_cam_src_exposure_mode_get_type(void)
{
	...
	if (the_type == 0) {
		...
		the_type =
		    g_enum_register_static(g_intern_static_string("GstRpiCamSrcExposureMode"),
					   values);
	}
	return the_type;
}
	...
	if (the_type == 0) {
		...
		the_type =
		    g_enum_register_static(g_intern_static_string
					   ("GstRpiCamSrcExposureMeteringMode"), values);
	}
	return the_type;
}
...
GType gst_rpi_cam_src_awb_mode_get_type(void)
{
	...
	if (the_type == 0) {
		...
		the_type = g_enum_register_static(g_intern_static_string("GstRpiCamSrcAWBMode"),
						  values);
	}
	return the_type;
}
...
GType gst_rpi_cam_src_image_effect_get_type(void)
{
	...
	if (the_type == 0) {
		...
		the_type = g_enum_register_static(g_intern_static_string("GstRpiCamSrcImageEffect"),
						  values);
	}
	return the_type;
}
...
GType gst_rpi_cam_src_flicker_avoidance_get_type(void)
{
	...
	if (the_type == 0) {
		...
		the_type =
		    g_enum_register_static(g_intern_static_string("GstRpiCamSrcFlickerAvoidance"),
					   values);
	}
	return the_type;
}
